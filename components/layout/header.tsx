...
export function Header({
  ...
  const storeCartCount = useCartCount();
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <Button
              variant="primary"
              size="md"
              className="hidden sm:inline-flex rounded-xl font-semibold gap-2 cursor-pointer shadow-sm hover:shadow-md"
            ...
            <Button
              variant="icon"
              size="icon"
              className="hidden sm:inline-flex relative text-slate-700 hover:text-red-500 cursor-pointer"
            ...
            <Link
              href="/cart"
              className="relative inline-flex items-center justify-center w-10 h-10 rounded-xl text-slate-700 hover:text-[#2563eb] hover:bg-slate-100 transition-colors cursor-pointer"
              aria-label="سبد خرید"
            >
              <ShoppingCart className="w-5 h-5" />
              <span className="absolute -top-1 -right-1 bg-[#2563eb] text-white text-[11px] font-bold w-5 h-5 rounded-full flex items-center justify-center shadow-xs">
                {cartCount}
              </span>
            </Link>
          </div>
